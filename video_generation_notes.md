...
以下图片均从论文 arXiv 源码或作者官方仓库提取，保存在 `figures/original/`，不是自行绘制的示意图。Markdown 中使用本地图片；点击来源可核对论文原图与图号。

### Genie：latent action 世界模型

![Genie 原论文架构图](figures/original/genie/genie_architecture.png)
...
![HunyuanVideo 官方架构图](figures/original/hunyuanvideo_overview.png)
...
![Wan Video DiT 架构图](figures/original/wan/video_dit/dit_arch.png)
...
![SANA-Video 原论文模型图](figures/original/sana/model.png)
...
![LingBot-Video 原论文架构图](figures/original/lingbot/architecture/architecture.png)
...
![Step-Video-T2V 模型架构](figures/original/recent/step_video_model_architecture.png)
...
![HunyuanVideo 1.5 架构图](figures/original/recent/hunyuanvideo15_architecture.png)
...
![Epona 世界模型流程](figures/original/recent/epona_pipeline.png)
